						    ...
						    <div class="panel-heading">
						      <h4 class="unicase-checkout-title">
						        <a data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseTwo">
						          <span>2</span>MUDAR PALAVRA PASSE
						        </a>
						      </h4>
						    </div>
...
<div class="form-group">
					    <label class="info-title" for="Current Password">PALAVRA PASSE ATUAL<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="New Password">NOVA PALAVRA PASSE <span>*</span></label>
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">CONFIRMAR PALAVRA PASSE <span>*</span></label>
